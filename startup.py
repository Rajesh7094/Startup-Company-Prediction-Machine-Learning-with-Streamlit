...
st.image('pic6.jpg',caption='Predict Your Future', width= 400)
st.markdown('</div>', unsafe_allow_html=True)

loaded_model = pickle.load(open(
    "D:\\Successed Project\\Startup-Company-Prediction-Machine-Learning\\startup_model.sav",
    'rb'))
...
def main():
    d1 = {
        ...
        'Security': 22, 'Advertising': 23, 'Marketing|Email': 24,
        'Analytics|Security|Network / Hosting / Infrastructure': 25,
        'Human Resources (HR)|Marketing|Career / Job Search': 26, 'Cloud Computing|Healthcare|E-Commerce': 27,
        'Media|Analytics|Publishing|Mobile|Education': 28, 'E-Commerce|Energy|Media': 29, 'Media|Analytics': 30,
        'Advertising|Marketing|Analytics': 31, 'E-Commerce|Analytics': 32, 'E-Commerce|Advertising|Analytics': 33,
        'Enterprise Software': 34, 'Analytics|Advertising|Cloud Computing|Marketing': 35,
        'Analytics|Network / Hosting / Infrastructure': 36,
        'Finance': 37, 'E-Commerce|Marketing': 38, 'Education|E-Commerce|Mobile': 39,
        'E-Commerce|Retail|Marketing|Mobile|Advertising|Deals': 40, 'Analytics|Market Research|Mobile': 41,
        'Advertising|Mobile|Analytics': 42,
        'Media|Analytics|Entertainment': 43, 'Analytics|Retail|Mobile': 44, 'Analytics|Cloud Computing': 45,
        'Transportation|Analytics': 46, 'Analytics|Publishing|Mobile': 47, 'Analytics|Mobile': 48,
        ...
        'Analytics|Food & Beverages|Social Networking|Mobile': 52, 'E-Commerce|Analytics|Advertising|Mobile': 53,
        'Media|Advertising|Analytics|Marketing': 54, 'E-Commerce|Retail|Analytics': 55,
        'Social Networking': 56, 'Healthcare': 57, 'E-Commerce|Mobile': 58, 'Real Estate': 59, 'E-Commerce': 60,
        'Mobile|Advertising|Social Networking|Marketing|E-Commerce|Analytics|Enterprise Software': 61,
        'Network / Hosting / Infrastructure|Food & Beverages|Analytics': 62, 'Analytics|E-Commerce|Marketing': 63,
        'Retail': 64, 'Market Research': 65, 'Retail|Mobile': 66, 'Mobile|Marketing': 67,
        'Network / Hosting / Infrastructure': 68,
        'Real Estate|Mobile|E-Commerce': 69,
        'Media|Entertainment|Analytics|Network / Hosting / Infrastructure|Publishing': 70,
        'E-Commerce|Email|Analytics|Marketing': 71, 'Analytics|Crowdfunding|Search|Marketing': 72,
        'Analytics|Healthcare': 73,
        'Network / Hosting / Infrastructure|Enterprise Software|Software Development|Analytics': 74,
        'Analytics|Telecommunications': 75,
        'Marketing|Enterprise Software|Analytics': 76, 'Media': 77, 'Mobile': 78,
        'E-Commerce|Food & Beverages|Mobile': 79, 'Education': 80, 'Social Networking|Mobile': 81,
        'Entertainment|Media|Mobile': 82, 'Search': 83, 'Advertising|Gaming|Marketing': 84, 'Analytics|Insurance': 85,
        'E-Commerce|Retail|Mobile': 86, 'Gaming|CleanTech|Social Networking|Energy': 87,
        'Advertising|Media|Mobile|Marketing': 88,
        'Analytics|Software Development|Marketing': 89, 'Space Travel': 90, 'Search|Enterprise Software|Mobile': 91,
        'Analytics|Marketing|Software Development': 92, 'Analytics|Security|Enterprise Software': 93,
        ...
        'Energy': 105, 'CleanTech|Analytics|Real Estate|Energy': 106, 'Security|Cloud Computing': 107,
        'CleanTech|Energy': 108, 'E-Commerce|Enterprise Software|Analytics': 109,
        'E-Commerce|Analytics|Mobile|Retail': 110, 'Entertainment': 111, 'Music': 112, 'Analytics|E-Commerce': 113,
        'Network / Hosting / Infrastructure|Analytics': 114,
        'E-Commerce|Publishing|Marketing': 115, 'E-Commerce|Market Research|Analytics|Deals|Finance': 116,
        ...
        'Classifieds|Network / Hosting / Infrastructure': 128, 'Media|Advertising|E-Commerce': 129,
        'Search|Healthcare': 130, 'Mobile|Telecommunications': 131,
        'Cloud Computing|E-Commerce|Classifieds': 132, 'Gaming|Entertainment': 133, 'Food & Beverages': 134,
        'Marketing|Mobile|E-Commerce': 135, 'Mobile|Cloud Computing|Enterprise Software': 136,
        'Music|Media|Software Development': 137, 'Analytics|Advertising': 138,
        'E-Commerce|Analytics|Advertising|Enterprise Software': 139, 'Cloud Computing|Analytics': 140
    }
    ...
    d2 = {
        ...
        'MARKETING': 44, 'PERSONAL APPS': 45, 'consumer behaviour': 46, 'customer servce': 47, 'CUSTOMER SERVICE': 48,
        'APP REVENUE': 49, 'intellectual property analysis and visualisation': 50,
        'retail': 51, 'data visualization': 52, 'service': 53, 'social media': 54, 'security': 55, 'operation': 56,
        'Marketing, Sales': 57, 'operations, sales, marketing': 58,
        'research': 59, 'Marketing, Technology, Finance & Accounting, Customer service': 60, 'Computing, training': 61,
        'Operations, marketing': 62, 'social advertising': 63, 'risk': 64,
        ...
        'customer engagement': 92, 'Marketing, Procurement, Human Resources': 93, 'CRM, Marketing, Human Resources': 94,
        'CRM': 95,
        'Merchandising, Marketing': 96, 'Travel Planning': 97,
        'Data Visualization, Content Marketing, Presentations': 98, 'News': 99, 'analtics': 100,
    ...
    d8 = {
        'Platform': 1, 'Cloud': 3, 'None': 4, 'Both': 5
    }
    d9 = {
    ...
    st.title('Enter your Company Details')
    a = st.text_input('Enter the Foundation of Start_up year')
    ...
    options_list = ['marketing', 'Marketing, sales', 'operations', 'Marketing & Sales',
                    ...
                    'marketing', 'sales', 'e-learning', 'software service',
                    ...
                    'customer service', 'CUSTOMER SERVICE', 'APP REVENUE',
                    ...
                    'Search EngineOptimization', 'Information management', 'strategy',
                    ...
                    'analytics', 'elearning', 'PHONE INTELLIGENCE', 'social branding',
                    'reporting', 'DASHBOARDS', 'localized behaviour',
                    'VIDEO STREAMING', 'PAYMENT', 'software', 'networking', 'wireless',
                    'advertising', 'game', 'search', 'consumer web', 'online music',
                    'media']
    d = st.selectbox("Choose Focus Function of Company", options_list)
    e = st.text_input("Enter the Employee Count ")
    ops = ['No', 'Yes']
    f = st.selectbox("Team Size Grown", ops)
    g = st.text_input("Enter the no of Co-founders ")
    ...
    ops4 = ['No', 'Yes']
    l = st.selectbox("Successful startups in the past", ops4)
    ops5 = ['Service', 'Product', 'Both', 'No Info']
    m = st.selectbox("Product or service company", ops5)
    ops6 = ['Platform', 'Cloud', 'None', 'Both']
    n = st.selectbox("Cloud or Platform based Service or Product", ops6)
